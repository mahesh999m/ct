...
<script src="/secure/lang/c/js/self-referential-structure.js"></script> 
						...
						<div class="col-xs-12 border-div opacity00" id="s1memory">
							<table align="center">
								<tbody>
									...
									<tr>
										<td style="text-align: center; color: green" id="address1">1024</td>
										<td style="text-align: center; color: green;">1026</td>
									</tr>
						...
						<div class="col-xs-12 border-div opacity00" id="s2memory">
							<table align="center">
								<tbody>
									...
									<tr>
										<td style="text-align: center; color: green"><span class="position" id="address2">1054</span></td>
										<td style="text-align: center; color: green;">1056</td>
									</tr>
